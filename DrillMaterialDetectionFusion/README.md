# Drill Material Detection (Sensor Fusion) - Starter Model Project

This project is designed to work exclusively with DEEPCRAFT™ Studio. Download it from [here](https://softwaretools.infineon.com/assets/com.ifx.tb.tool.deepcraftstudio)

## Use-case description

This starter model aims to provide general guidance on developing systems that detect machine operating conditions based on sound and vibration measurements (sensor fusion). 
While this project monitors a simple hand drill, the same concepts and workflow can be easily applied to any other machine, industrial or consumer.
...
`Units` - Folder with the Data Collection GraphUX project you can use for collecting more data.

`Models` - Folder where trained models, their predictions, and generated Edge code are saved.

`Tools`    - Folder containing scripts that modify acquired data for model training.


## Sensor settings specification

This starter project requires the [PSOC™ Edge E84 AI Evaluation Kit](https://www.infineon.com/evaluation-board/kit-pse84-ai). This platform is equipped with PSOC™ Edge E84, MEMS Microphone and IMU sensors. The board is designed for easy prototyping and lets you collect real-life data to easily build a compelling ML product fast.
...
For starting data collection, navigate to the `Units` folder and double-click the `Main.imunit` file.
...
The learning model is based on the Classification Project, configured with Conv1DLSTM combining a one-dimensional convolutional layer and a deep long-term short-term memory layer. 
![](Resources/imgs/model_wizard.png)

It has been trained using preprocessed drilling sounds of wood, plastic, and air, each lasting over 40 minutes.
![](Resources/imgs/training_datas.png)
