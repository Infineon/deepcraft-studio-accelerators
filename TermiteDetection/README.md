...
## Steps to get started: Model Training and Evaluation
   ...
   5. Place pictures of termites or real termites in front of the camera and observe detections from the live camera.
